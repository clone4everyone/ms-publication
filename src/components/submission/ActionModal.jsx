// src/components/submission/ActionModal.jsx
  ...
  const getModalConfig = () => {
    const configs = {
      ...
      reject: {
        ...
        buttonClass: 'bg-gradient-to-r from-rose-500 to-red-600 hover:from-rose-600 hover:to-red-700'
      },
      editor_sendback: {
      ...
      schedule: {
        ...
        buttonClass: 'bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700'
      }
    };
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-scale-in">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className={`p-6 bg-gradient-to-r ${config.gradient} text-white rounded-t-2xl`}>
        ...
        <div className="flex justify-end space-x-4 p-6 bg-gray-50 rounded-b-2xl">
          ...
          <button
            onClick={onConfirm}
            className={`px-6 py-3 rounded-xl text-white font-bold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl ${config.buttonClass}`}
          >
            Confirm
          </button>
        </div>
